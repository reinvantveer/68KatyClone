...
GETBIN   ;BSR CINS
         MOVE.B SERIN,D0
GOTBIN   MOVE.B D0,(A4)+
         ;MOVE.B D0,DOUT.L  ; INDICATOR WHILE LOADING
         ADDQ.L #1, D2
         MOVE.B D2, D3
         BNE NOACK
         ;MOVE.B #'_',D0
...
;STRING1 dc.b '  dc.l ',0
  ...
  IFEQ LOADADDR
ABOUTZBUG dc.b 13,10,'zBug(ROM) for 68Katy 20141115 by W. Sirichote, S. Chamberlin',13,10,0
  ENDC
  IFNE LOADADDR,0
ABOUTZBUG dc.b 13,10,'zBug(RAM) for 68Katy 20141115 by W. Sirichote, S. Chamberlin',13,10,0
  ENDC
